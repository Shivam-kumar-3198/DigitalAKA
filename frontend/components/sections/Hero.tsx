...
export default function Hero() {
  ...
  useEffect(() => {
    getDoc(doc(db, 'settings', 'hero')).then((snap) => {
      if (snap.exists()) setHero({ ...HERO_DEFAULTS, ...(snap.data() as typeof HERO_DEFAULTS) });
    });
  }, []);
  ...
  return (
    <section className="relative flex w-full min-h-[100dvh] flex-col justify-center overflow-hidden bg-[#fafcff] -mt-20 pt-20 pb-16 text-slate-900 selection:bg-[#1d5cf5] selection:text-white sm:pb-20">
      ...
      <div className="relative z-20 mx-auto max-w-[900px] px-4 sm:px-6 text-center">
        <h1
          className="mt-4 text-3xl font-extrabold leading-[1.15] tracking-tight text-slate-900 [animation:fade-up_0.5s_ease_forwards] sm:text-4xl md:text-5xl lg:text-[3.25rem] sm:leading-[1.1]"
        >
          <span className="text-transparent bg-clip-text bg-gradient-to-r from-[#1d5cf5] via-blue-500 to-cyan-500">
            {hero.headline}
          </span>
        </h1>

        <p className="mx-auto mt-4 sm:mt-6 max-w-2xl text-[15px] sm:text-[1.125rem] font-normal sm:font-medium text-slate-500 leading-relaxed [animation:fade-up_0.5s_ease_forwards]">
          {hero.subheadline}
        </p>

        <div className="mt-8 sm:mt-10 flex flex-col sm:flex-row items-center justify-center gap-3 sm:gap-4 [animation:fade-up_0.65s_ease_0.2s_both]">
          <Link
      ...
      {/* =========================================
          ...
          ========================================= */}
      {/* FIXED: We replaced flex-col with a CSS Grid for mobile (grid grid-cols-1 sm:grid-cols-2). 
        On lg screens, lg:block overrides the grid, preserving your exact absolute positioning. 
      */}
      <div className="relative z-10 mx-auto mt-12 sm:mt-20 grid grid-cols-1 sm:grid-cols-2 gap-4 sm:gap-6 px-4 sm:px-6 lg:block lg:h-[520px] lg:w-full lg:max-w-[1200px]">
        
        {/* Mobile Vertical Data Artery (Hidden on Desktop) */}
        <div className="absolute inset-y-0 left-1/2 w-[2px] bg-gradient-to-b from-[#1d5cf5] via-[#10b981] to-transparent lg:hidden -translate-x-1/2 opacity-20 pointer-events-none z-0"></div>
        <div className="absolute top-0 left-1/2 h-20 w-[2px] bg-gradient-to-b from-transparent via-[#1d5cf5] to-transparent lg:hidden -translate-x-1/2 animate-[vertical-flow_2s_linear_infinite] z-0 pointer-events-none"></div>
        ...
        {/* -----------------------------------------
            THE UI CARDS
            Added order-* classes for mobile flow control.
            ----------------------------------------- */}

        {/* 1. Performance Metrics */}
        <div className={`order-2 sm:col-span-1 relative w-full rounded-[17px] p-[1px] bg-gradient-to-br from-slate-200 via-white to-blue-200 shadow-[0_10px_30px_rgba(0,0,0,0.04)] lg:absolute lg:left-0 lg:top-[20px] lg:w-[280px] z-10 lg:transition-transform lg:duration-200 lg:hover:-translate-y-1 [animation:fade-in_0.8s_ease_0.3s_forwards]`}>
            ...
            <div className="flex items-center justify-between mb-3 sm:mb-4">
              ...
              <div className="flex flex-col text-right">
                <div className="flex items-center justify-end gap-1.5">
                  ...
                  <span className="text-xs font-medium sm:font-bold text-slate-400 uppercase tracking-widest">Without Us</span>
                </div>
                <span className="text-xs font-normal sm:font-semibold text-slate-400">Inbox Rate</span>
              </div>
            ...
            <div className="flex items-center justify-between">
              ...
              <div className="flex flex-col text-right">
                <div className="flex items-center justify-end gap-1.5">
                  ...
                  <span className="text-xs font-medium sm:font-bold text-slate-800 uppercase tracking-widest">DigitalAka</span>
                </div>
                <span className="text-xs font-normal sm:font-semibold text-slate-500">Inbox Rate</span>
              </div>
        ...
        {/* 2. Data Sources */}
        <div className={`order-4 sm:col-span-1 relative w-full rounded-[17px] p-[1px] bg-gradient-to-br from-slate-200 via-white to-blue-200 shadow-[0_10px_30px_rgba(0,0,0,0.04)] lg:absolute lg:bottom-[20px] lg:left-[40px] lg:w-[300px] z-10 lg:transition-transform lg:duration-200 lg:hover:-translate-y-1 [animation:fade-in_0.8s_ease_0.4s_forwards]`}>
          <div className="h-full w-full rounded-2xl bg-white p-4 sm:p-6">
            <div className="flex items-center justify-between mb-4 sm:mb-5">
              <h3 className="text-xs font-medium sm:font-bold uppercase tracking-widest text-slate-800">Your Campaigns</h3>
            ...
            <div className="grid grid-cols-2 gap-2 sm:gap-3">
              <div className="flex flex-col items-center justify-center rounded-xl bg-slate-50 border border-slate-100 p-3 sm:p-4">
                ...
                <span className="text-xs font-normal sm:font-bold text-slate-600 uppercase tracking-wide">Bulk Email</span>
              </div>
              <div className="flex flex-col items-center justify-center rounded-xl bg-slate-50 border border-slate-100 p-3 sm:p-4">
                ...
                <span className="text-xs font-normal sm:font-bold text-slate-600 uppercase tracking-wide">Bulk SMS</span>
              </div>
              <div className="flex flex-col items-center justify-center rounded-xl bg-slate-50 border border-slate-100 p-3 sm:p-4">
                ...
                <span className="text-xs font-normal sm:font-bold text-slate-600 uppercase tracking-wide">Voice SMS</span>
              </div>
        ...
        <div className={`order-1 sm:col-span-2 relative flex justify-center py-4 lg:py-0 lg:absolute lg:left-[50%] lg:top-[50%] lg:w-max lg:-translate-x-1/2 lg:-translate-y-1/2 z-20 [animation:fade-in_0.8s_ease_0.5s_forwards]`}>
        ...
        <div className={`order-3 sm:col-span-1 relative w-full rounded-[17px] p-[1px] bg-gradient-to-br from-slate-200 via-white to-emerald-200 shadow-[0_10px_30px_rgba(0,0,0,0.04)] text-center lg:absolute lg:right-4 lg:top-0 lg:w-[250px] z-10 lg:transition-transform lg:duration-200 lg:hover:-translate-y-1 [animation:fade-in_0.8s_ease_0.3s_forwards]`}>
          <div className="h-full w-full rounded-2xl bg-white p-4 sm:p-6">
            <div className="flex items-center justify-center gap-2 mb-4 sm:mb-6 text-xs font-medium sm:font-bold uppercase tracking-widest text-slate-800">
        ...
        <div className={`order-5 sm:col-span-2 relative w-full rounded-[17px] p-[1px] bg-gradient-to-br from-slate-200 via-white to-emerald-200 shadow-[0_10px_30px_rgba(0,0,0,0.04)] lg:absolute lg:bottom-[20px] lg:right-[24px] lg:w-[320px] z-10 lg:transition-transform lg:duration-200 lg:hover:-translate-y-1 [animation:fade-in_0.8s_ease_0.4s_forwards]`}>
          <div className="h-full w-full rounded-2xl bg-white p-4 sm:p-6">
            <div className="flex items-center justify-between mb-4 sm:mb-5">
              <h3 className="text-xs font-medium sm:font-bold uppercase tracking-widest text-slate-800">Endpoint Routing</h3>
            ...
            <div className="flex flex-col gap-2 sm:gap-3">
              <div className="flex items-center gap-3 sm:gap-4 rounded-lg border border-slate-100 bg-slate-50 p-2 sm:p-3">
                ...
                <div className="flex flex-col w-full">
                  <div className="flex justify-between items-center">
                    <span className="text-xs font-medium sm:font-bold text-slate-700 uppercase tracking-widest">Mobile Devices</span>
                    <span className="text-xs text-emerald-600 font-normal sm:font-bold uppercase">200ms</span>
                  </div>
              ...
              <div className="flex items-center gap-3 sm:gap-4 rounded-lg border border-slate-100 bg-slate-50 p-2 sm:p-3">
                ...
                <div className="flex flex-col w-full">
                  <div className="flex justify-between items-center">
                    <span className="text-xs font-medium sm:font-bold text-slate-700 uppercase tracking-widest">User Inboxes</span>
                    <span className="text-xs text-emerald-600 font-normal sm:font-bold uppercase">150ms</span>
                  </div>
                  <div className="w-full bg-slate-200 h-1 rounded-full mt-1 sm:mt-1.5 overflow-hidden">
